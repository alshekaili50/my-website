...
export class DashboardComponent implements OnInit  {
  ...
  @ViewChild("uae") uaeModel: ElementRef;
  @ViewChild("oman") omanModel: ElementRef;
  @ViewChild("ksa") ksaModel: ElementRef;
  ...
  readMore(accent){
    if(accent=='uae'){
      this.modalService.open( this.uaeModel,{ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
      ...
      this.modalService.open( this.omanModel,{ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
      ...
      this.modalService.open( this.ksaModel,{ariaLabelledBy: 'modal-basic-title'}).result.then((result) => {
